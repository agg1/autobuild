...
livecd/bootargs: net.ifnames=0 nokeymap nodhcp nosound nogpm memory_corruption_check=0 pbshutdown console=tty0 console=ttyS0,115200 hostname=proxy01 syslvmdev=/dev/sda
