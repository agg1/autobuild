...
livecd/bootargs: net.ifnames=0 nokeymap nodhcp nosound nogpm memory_corruption_check=1 nokeymap single console=tty0 console=ttyUSB0,115200 console=ttyS0,115200
# elevator=bfq
# ubsan_handle=OEAINVBSLF
# ubsan_handle=ELNVBSLF
livecd/rcdel: keymaps|boot netmount|default
#livecd/rcadd:
livecd/root_overlay: /home/autobuild/rootfs/flash
#livecd/overlay:
