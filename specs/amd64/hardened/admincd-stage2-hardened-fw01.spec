...
livecd/bootargs: net.ifnames=0 nokeymap nodhcp nosound nogpm memory_corruption_check=1 pbshutdown console=ttyS0,115200 console=ttyUSB0,115200 console=tty0
