...
livecd/bootargs: net.ifnames=0 nokeymap nodhcp nosound nogpm memory_corruption_check=1 pbshutdown nokeymap console=tty0 console=ttyUSB0,115200 console=ttyS0,115200 docache
