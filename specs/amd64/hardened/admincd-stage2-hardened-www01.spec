...
livecd/bootargs: net.ifnames=0 nokeymap nodhcp nosound nogpm memory_corruption_check=1 pbshutdown console=tty0 console=ttyS0,115200 hostname=www01 syslvmdev=/dev/sda
